# --- 🛠️ 檔案檢查小工具 (除錯用，確認沒問題後可刪除) ---
import os
st.warning("🔍 系統目前所在的資料夾是：" + os.getcwd())
st.info("📂 這個資料夾裡面有這些檔案：" + str(os.listdir('.')))

if os.path.exists("volunteer.jpg"):
    st.success("✅ 成功找到 volunteer.jpg！")
else:
    st.error("❌ 找不到 volunteer.jpg，請檢查檔名或上傳位置！")
# ----------------------------------------------------
