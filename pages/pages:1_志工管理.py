...
st.markdown(f"""
    ...
    .dash-label {{ font-size: 1.1rem; color: #666; font-weight: bold; }}
    .dash-value {{ font-size: 2rem; color: {PRIMARY}; font-weight: 900; margin: 5px 0; }}
    .dash-sub {{ font-size: 0.95rem; color: #888; }}
