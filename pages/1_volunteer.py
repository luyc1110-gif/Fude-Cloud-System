...
if st.session_state.page == 'home':
    ...
    st.markdown(f"""
    <div style="background: background-color: #9A8C98 100%; padding: 30px; border-radius: 20px; color: white; text-align: center; margin-bottom: 25px; box-shadow: 0 10px 25px rgba(81, 45, 168, 0.25);">
